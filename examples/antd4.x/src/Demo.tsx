                ...
                <div style={{
                    ...
                    <div style={{display: "flex", justifyContent: "flex-end", marginBottom: 15, gap: 10}}>
                        <Button
                            ...
                            icon={<div style={{width: 22, height: 22, lineHeight: "22px"}}>4.x</div>}
                            style={{
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
                                pointerEvents: majorVersion === 4 ? "none" : "auto",
                            }}
                        />
                        <Button
                            target="_blank"
                            ...
                            icon={<div style={{width: 22, height: 22, lineHeight: "22px"}}>5.x</div>}
                            style={{
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
                                pointerEvents: majorVersion === 5 ? "none" : "auto",
                            }}
                        />
                        <Button
                            target="_blank"
                            ...
                            icon={<div style={{width: 22, height: 22, lineHeight: "22px"}}>6.x</div>}
                            style={{
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
                                pointerEvents: majorVersion === 6 ? "none" : "auto",
                            }}
                        />
                        <Button
                            target="_blank"
                        ...
                        <Button
                            onClick={changeTheme}
                            icon={isSelectedLight ? <MoonOutlined/> : <SunOutlined/>}
                        />
                    </div>
                    ...
                    <Table
                        ...
                        style={{
                            border: `1px solid ${isSelectedLight ? "#f0f0f0" : "#303030"}`,
                            background: isSelectedLight ? "#efefef" : "#1f1f1f",
